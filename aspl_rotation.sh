export EXPERIMENT_NAME="ASPL_rotation_all_ori"
export MODEL_PATH="./stable-diffusion/stable-diffusion-2-1-base"
export CLEAN_TRAIN_DIR="data/n000050/set_B" 
...
accelerate launch attacks/aspl_rotation_ori.py \
...
accelerate launch train_dreambooth_rotation.py \
  --pretrained_model_name_or_path=$MODEL_PATH  \
  --enable_xformers_memory_efficient_attention \
  --train_text_encoder \
